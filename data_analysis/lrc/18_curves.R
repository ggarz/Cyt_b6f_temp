...
# Temp
gg_1_tleaf <- mean(gg_1$Tleaf)
gg_1_tleaf
# creating linear model
lm_gg1 <- lm(LEF ~ one.qL, data = gg_1, subset = one.qL < 0.99)
...
gg_2_tleaf
# creating linear model
lm_gg2 <- lm(LEF ~ one.qL, data = gg_2, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_6_tleaf
# creating linear model
lm_gg6 <- lm(LEF ~ one.qL, data = gg_6, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_9_tleaf
# creating linear model
lm_gg9 <- lm(LEF ~ one.qL, data = gg_9, subset = one.qL < 0.92)
# creating slope and intercept
...
### Curve 10 deleted for fitting purposes
...
gg_12_tleaf
# creating linear model
lm_gg12 <- lm(LEF ~ one.qL, data = gg_12, subset = one.qL < 0.775)
# creating slope and intercept
...
gg_15_tleaf
# creating linear model
lm_gg15 <- lm(LEF ~ one.qL, data = gg_15, subset = one.qL < 0.95)
# creating slope and intercept
...
gg_21_tleaf
# creating linear model
lm_gg21 <- lm(LEF ~ one.qL, data = gg_21, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_22_tleaf
# creating linear model
lm_gg22 <- lm(LEF ~ one.qL, data = gg_22, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_23_tleaf
# creating linear model
lm_gg23 <- lm(LEF ~ one.qL, data = gg_23, subset = one.qL < 0.99)
# creating slope and intercept
...
# Temp
gg_25_tleaf <- mean(gg_9$Tleaf)
gg_25_tleaf
# creating linear model
lm_gg25 <- lm(LEF ~ one.qL, data = gg_25, subset = one.qL > 0.25)
# creating slope and intercept
...
gg_26_tleaf
# creating linear model
lm_gg26 <- lm(LEF ~ one.qL, data = gg_26, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_28_tleaf
# creating linear model
lm_gg28 <- lm(LEF ~ one.qL, data = gg_28, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_29_tleaf
# creating linear model
lm_gg29 <- lm(LEF ~ one.qL, data = gg_29, subset = one.qL < 0.8)
# creating slope and intercept
...
gg_30_tleaf
# creating linear model
lm_gg30 <- lm(LEF ~ one.qL, data = gg_30, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_31_tleaf
# creating linear model
lm_gg31 <- lm(LEF ~ one.qL, data = gg_31, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_32_tleaf
# creating linear model
lm_gg32 <- lm(LEF ~ one.qL, data = gg_32, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_34_tleaf
# creating linear model
lm_gg34 <- lm(LEF ~ one.qL, data = gg_34, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_36_tleaf
# creating linear model
lm_gg36 <- lm(LEF ~ one.qL, data = gg_36, subset = one.qL < 0.9)
# creating slope and intercept
...
# Temp
gg_38_tleaf <- mean(gg_38$Tleaf)
gg_38_tleaf
# creating linear model
lm_gg38 <- lm(LEF ~ one.qL, data = gg_38, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_39_tleaf
# creating linear model
lm_gg39 <- lm(LEF ~ one.qL, data = gg_39, subset = one.qL < 0.99)
# creating slope and intercept
...
### Creating dataframe
vqmax18_df <- data.frame(
  id = c("gg_1", "gg_2", "gg_3", "gg_4", "gg_5", "gg_6", "gg_7", "gg_8", "gg_9",
         "gg_11", "gg_12", "gg_14", "gg_15", "gg_16", "gg_18", 
  ...
  slope_18 = c(gg_1_slope, gg_2_slope, gg_3_slope, gg_4_slope, gg_5_slope, gg_6_slope, gg_7_slope, gg_8_slope, gg_9_slope,
               gg_11_slope, gg_12_slope, gg_14_slope, gg_15_slope, gg_16_slope, gg_18_slope, 
  ...
  intercept_18 = c(gg_1_slope, gg_2_intercept, gg_3_intercept, gg_4_intercept, gg_5_intercept, gg_6_intercept, gg_7_intercept, gg_8_intercept, gg_9_intercept,
                   gg_11_intercept, gg_12_intercept, gg_14_intercept, gg_15_intercept, gg_16_intercept, gg_18_intercept, 
  ...
  tleaf_18 = c(gg_1_slope, gg_2_tleaf, gg_3_tleaf, gg_4_tleaf, gg_5_tleaf, gg_6_tleaf, gg_7_tleaf, gg_8_tleaf, gg_9_tleaf,
                   gg_11_tleaf, gg_12_tleaf, gg_14_tleaf, gg_15_tleaf, gg_16_tleaf, gg_18_tleaf, 
...
### calculating Vqmax
vqmax18_df$vqmax_18 <- vqmax18_df$intercept + vqmax18_df$slope
vqmax18_df

### adding treatment column
vqmax18_df$replicate <- as.numeric(gsub("\\D", "", vqmax18_df$id))
vqmax18_df$treatment <- ifelse(vqmax18_df$replicate %% 2 == 1,
                               "25c",
                               "35c")
vqmax18_df$replicate <- NULL
vqmax18_df

### add leaf temp
vqmax18_df$tleaf_fac <- "18c"
vqmax18_df


### graph and stats time
ggplot(vqmax18_df, aes(x = treatment, y = vqmax_18)) + geom_boxplot() 
vqmax18_lm <- lm(vqmax_18 ~ treatment, data = vqmax18_df)
anova(vqmax18_lm)
plot(vqmax18_lm)

### write .csv
write.csv(vqmax18_df, "vqmax18_df.csv")
