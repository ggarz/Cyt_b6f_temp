...
lm_gg2 <- lm(LEF ~ one.qL, data = gg_2, subset = one.qL < 0.85)
...
gg_5_tleaf
# creating linear model
lm_gg5 <- lm(LEF ~ one.qL, data = gg_5, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_6_tleaf
# creating linear model
lm_gg6 <- lm(LEF ~ one.qL, data = gg_6, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_8_tleaf
# creating linear model
lm_gg8 <- lm(LEF ~ one.qL, data = gg_8, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_12_tleaf
# creating linear model
lm_gg12 <- lm(LEF ~ one.qL, data = gg_12, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_14_tleaf
# creating linear model
lm_gg14 <- lm(LEF ~ one.qL, data = gg_14, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_25_tleaf
# creating linear model
lm_gg25 <- lm(LEF ~ one.qL, data = gg_25, subset = one.qL < 0.9)
# creating slope and intercept
...
gg_32_tleaf
# creating linear model
lm_gg32 <- lm(LEF ~ one.qL, data = gg_32, subset = one.qL < 0.85)
# creating slope and intercept
...
vqmax36_df <- data.frame(
  ...
  tleaf_30 = c(gg_2_tleaf, gg_3_tleaf, gg_4_tleaf, gg_5_tleaf, gg_6_tleaf, gg_7_tleaf, 
                   gg_8_tleaf, gg_9_tleaf, gg_10_tleaf, gg_11_tleaf, gg_12_tleaf, gg_14_tleaf, 
                   gg_15_tleaf, gg_18_tleaf, gg_19_tleaf, gg_21_tleaf, gg_23_tleaf, gg_24_tleaf, 
                   gg_25_tleaf, gg_26_tleaf, gg_28_tleaf, gg_31_tleaf, gg_33_tleaf, gg_35_tleaf, 
                   gg_37_tleaf, gg_38_tleaf, gg_39_tleaf, gg_40_tleaf)
)
vqmax36_df
