...
gg_2_tleaf
# creating linear model
lm_gg2 <- lm(LEF ~ one.qL, data = gg_2, subset = one.qL < 0.6)
# creating slope and intercept
...
gg_5_tleaf# creating linear model
...
gg_8_tleaf
# creating linear model
lm_gg8 <- lm(LEF ~ one.qL, data = gg_8, subset = one.qL > 0 & one.qL < 0.6)
# creating slope and intercept
...
gg_10_tleaf
# creating linear model
lm_gg10 <- lm(LEF ~ one.qL, data = gg_10, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_14_tleaf
# creating linear model
lm_gg14 <- lm(LEF ~ one.qL, data = gg_14, subset = one.qL < 0.5)
# creating slope and intercept
...
gg_16_tleaf
# creating linear model
lm_gg16 <- lm(LEF ~ one.qL, data = gg_16, subset = one.qL < 0.6)
# creating slope and intercept
...
gg_22_tleaf
# creating linear model
lm_gg22 <- lm(LEF ~ one.qL, data = gg_22, subset = one.qL < 0.55)
# creating slope and intercept
...
gg_24_tleaf# creating linear model
lm_gg24 <- lm(LEF ~ one.qL, data = gg_24, subset = one.qL < 0.6)
# creating slope and intercept
...
gg_26_tleaf
# creating linear model
lm_gg26 <- lm(LEF ~ one.qL, data = gg_26, subset = one.qL > 0 & one.qL < 0.8)
# creating slope and intercept
...
gg_28_tleaf
# creating linear model
lm_gg28 <- lm(LEF ~ one.qL, data = gg_28, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_30_tleaf
# creating linear model
lm_gg30 <- lm(LEF ~ one.qL, data = gg_30, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_33_tleaf
# creating linear model
lm_gg33 <- lm(LEF ~ one.qL, data = gg_33, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_34_tleaf
# creating linear model
lm_gg34 <- lm(LEF ~ one.qL, data = gg_34, subset = one.qL < 0.65)
# creating slope and intercept
...
gg_35_tleaf
# creating linear model
lm_gg35 <- lm(LEF ~ one.qL, data = gg_35, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_37_tleaf
# creating linear model
lm_gg37 <- lm(LEF ~ one.qL, data = gg_37, subset = one.qL < 0.75)
# creating slope and intercept
...
vqmax48_df <- data.frame(
  ...
  tleaf_48 = c(gg_1_tleaf, gg_2_tleaf, gg_3_tleaf, gg_5_tleaf, gg_6_tleaf, gg_7_tleaf, gg_9_tleaf,
                   gg_10_tleaf, gg_12_tleaf, gg_14_tleaf, gg_15_tleaf, gg_16_tleaf, gg_18_tleaf, 
                   gg_21_tleaf, gg_22_tleaf, gg_23_tleaf, gg_24_tleaf, gg_26_tleaf, 
                   gg_28_tleaf, gg_29_tleaf, gg_30_tleaf, gg_31_tleaf, gg_32_tleaf, gg_34_tleaf, 
                   gg_35_tleaf, gg_36_tleaf, gg_38_tleaf, gg_39_tleaf)
)
vqmax48_df
