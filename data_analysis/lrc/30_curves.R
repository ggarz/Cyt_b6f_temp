...
gg_6_tleaf
# creating linear model
lm_gg6 <- lm(LEF ~ one.qL, data = gg_6, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_14_tleaf
# creating linear model
lm_gg14 <- lm(LEF ~ one.qL, data = gg_14, subset = one.qL < 0.99)
# creating slope and intercept
...
gg_19_tleaf
# creating linear model
lm_gg19 <- lm(LEF ~ one.qL, data = gg_19, subset = one.qL < 0.92)
# creating slope and intercept
...
gg_22_tleaf
# creating linear model
lm_gg22 <- lm(LEF ~ one.qL, data = gg_22, subset = one.qL < 0.8)
# creating slope and intercept
...
gg_23_tleaf
# creating linear model
lm_gg23 <- lm(LEF ~ one.qL, data = gg_23, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_26_tleaf
# creating linear model
lm_gg26 <- lm(LEF ~ one.qL, data = gg_26, subset = one.qL < 0.77)
# creating slope and intercept
...
gg_30_tleaf
# creating linear model
lm_gg30 <- lm(LEF ~ one.qL, data = gg_30, subset = one.qL < 0.8125)
# creating slope and intercept
...
# Temp
gg_34_tleaf <- mean(gg_34_filtered$Tleaf)
gg_34_tleaf
# creating linear model
...
gg_35_tleaf
# creating linear model
lm_gg35 <- lm(LEF ~ one.qL, data = gg_35, subset = one.qL < 0.7)
# creating slope and intercept
...
gg_40_tleaf
# creating linear model
lm_gg40 <- lm(LEF ~ one.qL, data = gg_40, subset = one.qL < 0.6)
# creating slope and intercept
...
vqmax30_df <- data.frame(
  ...
  tleaf_30 = c(gg_3_tleaf, gg_4_tleaf, gg_6_tleaf, gg_7_tleaf, gg_8_tleaf,
               gg_9_tleaf, gg_10_tleaf, gg_11_tleaf, gg_12_tleaf, gg_14_tleaf, 
               gg_16_tleaf, gg_18_tleaf, gg_19_tleaf, gg_22_tleaf, gg_23_tleaf,
               gg_24_tleaf, gg_25_tleaf, gg_26_tleaf, gg_27_tleaf, gg_29_tleaf, 
               gg_30_tleaf,  gg_31_tleaf, gg_32_tleaf, gg_33_tleaf, gg_34_tleaf, 
               gg_35_tleaf, gg_37_tleaf, gg_40_tleaf)
)
vqmax30_df
