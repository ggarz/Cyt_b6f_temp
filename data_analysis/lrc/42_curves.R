...
gg_3_tleaf
# creating linear model
lm_gg3 <- lm(LEF ~ one.qL, data = gg_3, subset = one.qL < 0.75)
# creating slope and intercept
...
gg_4_tleaf
# creating linear model
lm_gg4 <- lm(LEF ~ one.qL, data = gg_4, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_5_tleaf
# creating linear model
lm_gg5 <- lm(LEF ~ one.qL, data = gg_5, subset = one.qL < 0.85)
# creating slope and intercept
...
gg_12_tleaf# creating linear model
...
gg_14_tleaf
# creating linear model
lm_gg14 <- lm(LEF ~ one.qL, data = gg_14, subset = one.qL < 0.7)
# creating slope and intercept
...
gg_18_tleaf
# creating linear model
lm_gg18 <- lm(LEF ~ one.qL, data = gg_18, subset = one.qL < 0.8)
# creating slope and intercept
...
gg_28_tleaf
# creating linear model
lm_gg28 <- lm(LEF ~ one.qL, data = gg_28, subset = one.qL < 0.8)
# creating slope and intercept
...
gg_34_tleaf
# creating linear model
lm_gg34 <- lm(LEF ~ one.qL, data = gg_34, subset = one.qL < 0.56)
# creating slope and intercept
...
gg_38_tleaf
# creating linear model
lm_gg38 <- lm(LEF ~ one.qL, data = gg_38, subset = one.qL < 0.65)
# creating slope and intercept
...
vqmax42_df <- data.frame(
  ...
  tleaf_42 = c(gg_2_tleaf, gg_3_tleaf, gg_4_tleaf, gg_5_tleaf, gg_6_tleaf, gg_7_tleaf, gg_9_tleaf,
                   gg_10_tleaf, gg_12_tleaf, gg_14_tleaf, gg_16_tleaf, gg_18_tleaf, 
                   gg_21_tleaf, gg_22_tleaf, gg_24_tleaf, gg_25_tleaf, gg_26_tleaf, 
                   gg_27_tleaf, gg_28_tleaf, gg_29_tleaf, gg_30_tleaf, gg_32_tleaf, gg_34_tleaf, 
                   gg_35_tleaf, gg_36_tleaf, gg_38_tleaf, gg_39_tleaf, gg_40_tleaf)
)
vqmax42_df
