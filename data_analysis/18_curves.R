...
lm_gg1 <- lm(LEF ~ one.qL, data = gg_1, subset = one.qL > 0.6)
...
# creating linear model
lm_gg2 <- lm(LEF ~ one.qL, data = gg_2, subset = one.qL < 0.8)
# creating slope and intercept
...
# creating linear model
lm_gg10 <- lm(LEF ~ one.qL, data = gg_10, subset = one.qL < 0.85)
# creating slope and intercept
...
# creating linear model
lm_gg12 <- lm(LEF ~ one.qL, data = gg_12, subset = one.qL < 0.5)
# creating slope and intercept
...
# creating linear model
lm_gg18 <- lm(LEF ~ one.qL, data = gg_18, subset = one.qL < 0.9)
# creating slope and intercept
...
# creating linear model
lm_gg34 <- lm(LEF ~ one.qL, data = gg_34, subset = (one.qL < 0.7))
# creating slope and intercept
...
# creating linear model
lm_gg38 <- lm(LEF ~ one.qL, data = gg_38, subset = one.qL < 0.75)
# creating slope and intercept
